...
class DemandeVisiteController {
    ...
    def save(DemandeVisite demandeVisiteInstance) {
        ...
        demandeVisiteService.insertOrUpdateDemandeVisite(demandeVisiteService)
        request.withFormat {
            form multipartForm {
    ...
    def update(DemandeVisite demandeVisiteInstance) {
        ...
        //demandeVisiteInstance.save flush: true
        demandeVisiteService.insertOrUpdateDemandeVisite(demandeVisiteInstance)
        request.withFormat {
            form multipartForm {
...
//        demandeVisiteInstance.delete flush: true
        demandeVisiteService.deleteDemandeVisite(demandeVisiteService)
